...
X_text,Y_text  = create_dataset(tem_input_data, num_samples=52040)
...
for i in range(1, epochs+1):
    ...
    for ( batch , (input_batch, output_batch)) in enumerate(dataset.take(steps_per_epoch)):
        ...
        if (batch+1)%20 == 0:
            print(datetime.now())
            print(tem_input_data+" total loss: {} epoch {} batch {} ".format(batch_loss.numpy(), i, batch+1))
